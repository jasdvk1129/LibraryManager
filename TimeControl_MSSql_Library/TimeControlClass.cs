...
using TimeControl_MSSql_Library.Enums;
using TimeControl_MSSql_Library.Methods;
using TimeControl_MSSql_Library.Modules;

namespace TimeControl_MSSql_Library
{
    /// <summary>
    /// 時控
    /// </summary>
    public class TimeControlClass
    {
        ...
        public TimeControlClass(int groupIndex, string DataSource, string InitialCatalog, string UserID, string Password)
        {
            ...
            MSSqlMethod = new MSSqlMethod(GroupIndex, DataSource, InitialCatalog, UserID, Password);
            MSSqlMethod.CheckDataTableExistFunction();
        ...
        public DefaultBoolean Time_Keep_Control_Function()
        {
            ...
            TimeControlConfig = MSSqlMethod.SearchTimeControl();
            SpecificDate = MSSqlMethod.SearchTimeControlSetting();
