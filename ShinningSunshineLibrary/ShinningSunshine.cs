...
namespace ShinningSunshineLibrary
{
    public class ShinningSunshine
    {
        ...
        /// <param name="latitude">緯度</param>
        /// <returns></returns>
        public static DateTime GetSunriseTime(DateTime date, double longitude, double latitude)
        {
            double start = 0;
            double end = 0;
            SunRiset(date.Year, date.Month, date.Day, longitude, latitude, -35.0 / 60.0, 1, ref start, ref end);
            return ToLocalTime(date, start);
        }
        /// <summary>
        /// 取得日沒時間
        /// </summary>
        ...
        /// <param name="latitude">緯度</param>
        /// <returns></returns>
        public static DateTime GetSunsetTime(DateTime date, double longitude, double latitude)
        {
            double start = 0;
            double end = 0;
            SunRiset(date.Year, date.Month, date.Day, longitude, latitude, -35.0 / 60.0, 1, ref start, ref end);
            return ToLocalTime(date, end);
        }
        #endregion
        ...
        /// <param name="tset">日落時刻</param>
        /// <returns>太陽有出沒現象，return 0.極晝，+1.極夜，-1.日出或日落</returns>
    ...
    public class SunTimeResult
    {
        ...
        /// 構造函數
        /// </summary>
        /// <param name="sunrise">日出時間</param>
        /// <param name="sunset">日落時間</param>
